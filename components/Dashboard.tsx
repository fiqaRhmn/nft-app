  ...
  return (
    <div>
      <Header />
       ...
       <div>
          <div className='flex flex-col justify-center items-center bg-gray-100 h-36'>
            
           </div>
           <UserCircleIcon className="h-32 w-32 text-purple-700 -mt-28 shadow-md rounded-full ml-4 bg-white" />
        </div>
      ...
      {isModalVisible && (
        ...
        //     <h2 className="text-2xl mb-4">{selectedNFT?.name}</h2>
        //     <Image 
        ...
        //       height={200}
        //     />
        //     <p className="text-lg mt-4">{selectedNFT?.description}</p>
        //     <button 
